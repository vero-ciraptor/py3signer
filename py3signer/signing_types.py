...
class AggregationSlotSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="AGGREGATION_SLOT"):
...
class AggregateAndProofSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="AGGREGATE_AND_PROOF"):
...
class AggregateAndProofV2SignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="AGGREGATE_AND_PROOF_V2"):
...
class AttestationSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="ATTESTATION"):
...
class BlockV2SignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="BLOCK_V2"):
...
class DepositSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="DEPOSIT"):
...
class RandaoRevealSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="RANDAO_REVEAL"):
...
class VoluntaryExitSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="VOLUNTARY_EXIT"):
...
class SyncCommitteeMessageSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="SYNC_COMMITTEE_MESSAGE"):
...
class SyncCommitteeSelectionProofSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="SYNC_COMMITTEE_SELECTION_PROOF"):
...
class SyncCommitteeContributionAndProofSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="SYNC_COMMITTEE_CONTRIBUTION_AND_PROOF"):
...
class ValidatorRegistrationSignRequest(msgspec.Struct, kw_only=True, frozen=True, tag_field="type", tag="VALIDATOR_REGISTRATION"):
