...
def sign_data(
    ...
    Args:
        storage: Key storage to retrieve the secret key from
    ...
    secret_key = storage.get_secret_key(pubkey_hex)
...
class Signer:
    ...
    def sign_data(
        ...
        """Sign data with the specified key (delegates to module-level function)."""
        return sign_data(self._storage, pubkey_hex, data, domain)
