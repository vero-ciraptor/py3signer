...
class TestSignRequestParsing:
    ...
    def test_parse_attestation_request(self):
    ...
    def test_parse_randao_request(self):
    ...
    def test_parse_voluntary_exit_request(self):
    ...
    def test_parse_block_v2_request(self):
    ...
    def test_parse_without_signing_root(self):
    ...
    def test_parse_missing_fork_info(self):
...
class TestGetDomainForRequest:
    ...
    def test_attestation_domain(self):
    ...
    def test_voluntary_exit_domain(self):
    ...
    def test_aggregation_slot_domain(self):
    ...
    def test_sync_committee_message_domain(self):
    ...
    def test_sync_committee_selection_proof_domain(self):
    ...
    def test_validator_registration_domain(self):
...
class TestAllSigningTypes:
    ...
    def test_all_types_discriminate(self, type_name, expected_class):
        ...
        type_data = {
            ...
            "AGGREGATE_AND_PROOF": {"aggregate_and_proof": {"aggregator_index": "1", "aggregate": {}, "selection_proof": "0x0"}},
            "AGGREGATE_AND_PROOF_V2": {"aggregate_and_proof": {}},
            "ATTESTATION": {"attestation": {"slot": "1", "index": "0", "beacon_block_root": "0x0", "source": {}, "target": {}}},
            "BLOCK": {"block": {}},
            "BLOCK_V2": {"beacon_block": {}},
            "DEPOSIT": {"deposit": {"pubkey": "0x0", "withdrawal_credentials": "0x0", "amount": "32000000000", "genesis_fork_version": "0x0"}},
            "RANDAO_REVEAL": {"randao_reveal": {"epoch": "1"}},
            "VOLUNTARY_EXIT": {"voluntary_exit": {"epoch": "1", "validator_index": "0"}},
            "SYNC_COMMITTEE_MESSAGE": {"sync_committee_message": {"slot": "1", "beacon_block_root": "0x0", "validator_index": "0"}},
            "SYNC_COMMITTEE_SELECTION_PROOF": {"sync_aggregator_selection_data": {"slot": "1", "subcommittee_index": "0"}},
            "SYNC_COMMITTEE_CONTRIBUTION_AND_PROOF": {"contribution_and_proof": {"aggregator_index": "1", "contribution": {}, "selection_proof": "0x0"}},
            "VALIDATOR_REGISTRATION": {"validator_registration": {"fee_recipient": "0x0", "gas_limit": "30000000", "timestamp": "1", "pubkey": "0x0"}},
        }
